...
from controllers.generic.merlin_backtesting import MerlinBacktesting  # noqa: E402


async def backtest():
    backtesting_engine = MerlinBacktesting()
    config = backtesting_engine.get_controller_config_instance_from_yml("conf_generic.merlin_WIF.yml")
