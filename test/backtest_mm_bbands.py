...
from controllers.generic.mm_bbands_backtesting import MmBbandsBacktesting  # noqa: E402


async def backtest():
    backtesting_engine = MmBbandsBacktesting()
    config = backtesting_engine.get_controller_config_instance_from_yml("conf_generic.mm_bbands_DOGS.yml")
