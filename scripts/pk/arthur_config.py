...
class ArthurConfig(StrategyV2ConfigBase):
    ...
    trend_reversal_sell_min_rsi: int = Field(78, client_data=ClientFieldData(is_updatable=True))
    trend_reversal_buy_max_rsi: int = Field(22, client_data=ClientFieldData(is_updatable=True))