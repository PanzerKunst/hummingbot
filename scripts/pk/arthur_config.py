...
class ArthurConfig(StrategyV2ConfigBase):
    ...
    trend_start_price_change_threshold_pct: Decimal = Field(0.4, client_data=ClientFieldData(is_updatable=True))
    ...
    trend_start_volume_mul: int = Field(3, client_data=ClientFieldData(is_updatable=True))
