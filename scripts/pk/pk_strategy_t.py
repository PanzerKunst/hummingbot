...
from scripts.thunderfury_config import ThunderfuryConfig


class PkStrategyT(StrategyV2Base):
    def __init__(self, connectors: Dict[str, ConnectorBase], config: ThunderfuryConfig):
