...
class ExcaliburConfig(StrategyV2ConfigBase):
    ...
    # Triple Barrier
    sma_cross_stop_loss_pct: Decimal = Field(2.5, client_data=ClientFieldData(is_updatable=True))
    mean_reversion_stop_loss_pct: Decimal = Field(0.7, client_data=ClientFieldData(is_updatable=True))
    ...
    bb_length: int = Field(20, client_data=ClientFieldData(is_updatable=True))
    bb_std_dev: Decimal = Field(2.5, client_data=ClientFieldData(is_updatable=True))
    ...
    sma_cross_trailing_stop_activation_pct: Decimal = Field(2.5, client_data=ClientFieldData(is_updatable=True))
