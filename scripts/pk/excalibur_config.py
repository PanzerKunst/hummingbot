...
class ExcaliburConfig(StrategyV2ConfigBase):
    ...
    rsi_peak_threshold_to_open_mr: Decimal = 64.0
    rsi_bottom_threshold_to_open_mr: Decimal = 36.0
    stoch_peak_threshold_to_open_mr: Decimal = 90
    stoch_bottom_threshold_to_open_mr: Decimal = 10
