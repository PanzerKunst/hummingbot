...
class ExcaliburConfig(StrategyV2ConfigBase):
    ...
    min_rsi_to_open_sell_order: int = Field(30, client_data=ClientFieldData(is_updatable=True))
    max_rsi_to_open_buy_order: int = Field(70, client_data=ClientFieldData(is_updatable=True))
