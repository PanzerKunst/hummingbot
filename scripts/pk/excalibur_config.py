...
class ExcaliburConfig(StrategyV2ConfigBase):
    ...
    rsi_crash_bottom_threshold: Decimal = Field(37.0, client_data=ClientFieldData(is_updatable=True))
    rsi_crash_recovery_threshold: Decimal = Field(38.5, client_data=ClientFieldData(is_updatable=True))
